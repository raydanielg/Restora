...
<head>
    ...
    <meta property="og:title" content="{{ config('app.name', 'Restora') }}">
    <meta property="og:description" content="Order. Serve. Manage. Grow.">
    <meta property="og:image" content="{{ asset('favicon.png') }}">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="{{ config('app.name', 'Restora') }}">
    <meta name="twitter:description" content="Order. Serve. Manage. Grow.">
            ...
            <div class="hidden lg:flex flex-col justify-center relative overflow-hidden rounded-3xl h-[600px] shadow-2xl">
                ...
                <div class="relative z-10 p-12 flex flex-col justify-center h-full">
                    ...
                    <div class="flex items-center gap-3 mb-8 slide-up">
                        <img src="{{ asset('logo.png') }}?v=2" alt="Restora" class="w-12 h-12 object-contain">
                        <div>
                            <h1 class="text-2xl font-extrabold text-white tracking-tight">Restora</h1>
                            <p class="text-gold-300 text-sm font-medium">Order. Serve. Manage. Grow.</p>
                        </div>
                    </div>
