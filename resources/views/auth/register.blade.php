    ...
    <div class="bg-white rounded-none sm:rounded-2xl shadow-none sm:shadow-xl border-0 sm:border border-gray-100 overflow-hidden min-h-screen sm:min-h-0">
        ...
        <div class="p-6 sm:p-8">
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                {{-- Phone --}}
                <div>
                    <label for="phone" class="block text-sm font-semibold text-gray-700 mb-1.5">Phone Number <span class="text-gray-400 font-normal">(optional)</span></label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div class="flex items-start gap-2.5 p-3 rounded-lg bg-emerald-50 border border-emerald-100">
                    ...
                    <p class="text-xs text-emerald-700 leading-relaxed">After creating your account, you'll set up your restaurant details in a quick guided process.</p>
                </div>
