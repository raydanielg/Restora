...
<div class="w-full">
    <div class="bg-white rounded-none sm:rounded-2xl shadow-none sm:shadow-xl border-0 sm:border border-gray-100 overflow-hidden min-h-screen sm:min-h-0">
        ...
        <div class="px-6 sm:px-8 py-8 text-center border-b border-gray-100">
            ...
            <p class="text-gray-400 text-sm mt-1">Sign in to your Restora account</p>
        ...
        <div class="p-6 sm:p-8">
            ...
            {{-- Staff login link --}}
            <a href="{{ route('staff.login.form') }}" class="mt-4 w-full flex items-center justify-center gap-2 py-2.5 text-sm font-bold text-emerald-700 border-2 border-emerald-200 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
